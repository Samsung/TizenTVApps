		...
		window.Common = {
			API: {
				...
				TVKeyValue: function(){
					...
					this.KEY_VOLUMEUP = 447, // +
					this.KEY_VOLUMEDOWN = 448, // -
					this.KEY_MUTE = 449, // M
					//this.KEY_TOOLS = 84, // T   MISSING
					this.KEY_INFO = 457, // I
					this.KEY_EMODE = '',
					this.KEY_DMA = '',
					this.KEY_MENU = 18,
					...
					this.KEY_DOLBY_SRR = '',
					this.KEY_MTS = '',
					this.KEY_CHANNELUP = 427,
					this.KEY_PANEL_CH_DOWN = 428,
					...
					this.KEY_WHEELUP = '',
					this.KEY_RED = 403, // A
					this.KEY_GREEN = 404, // B
					this.KEY_YELLOW = 405, // C
					this.KEY_BLUE = 406, // D
					this.KEY_PREVIOUS = 412, // R
					this.KEY_PAUSE = 19, //;
					this.KEY_NEXT = 417, // F
					this.KEY_PLAY = 415, // P
					this.KEY_STOP = 413, // S
					this.KEY_ENTER = 13, // ENTER
					this.KEY_RETURN = 0, // ESC
