$(document).ready(function() {
 ...
 fotorama.show(a);
    ...
    $("#disable").on("click", function() {  //Background music disable
        $(this).hide();
        $("#light-overlay").hide();
        $("#enable").show();
        audioElement.pause();
        ...
        switch (e.which) {
            ...
            case 40:
                ...
                if ($("#div-flip").hasClass("active")) {
                	console.log("key downnnnnnnnnnnnnnnnnnnnnnnn1");
                    $("#div-flip").removeClass("active");
                    $("#div-rotate").focus();
                ...
                if ($("#div-rotate").hasClass("active")) {
                	console.log("key downnnnnnnnnnnnnnnnnnnnnnnn");
                    $("#div-rotate").removeClass("active");
                    $("#div-slideshow").focus();
                    $("#div-slideshow").addClass("active");
                }
                
                else
                	
                {
                	console.log("key downnnnnnnnnnnnnnnnnnnnnnnn3");
                    $("#div-slideshow").removeClass("active");
                    $("#div-flip").focus();
